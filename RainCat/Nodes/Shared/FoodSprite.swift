...
public class FoodSprite : SKSpriteNode, Palettable {
  public static let foodDishName = "FoodDish"
    private static let food = ["apple","bananas","watermelon","traigiday","coconut","cucumber","lemon","pumpkin","aubergine","cabbage"] //added
    
    public static var foodIndex = 0
  public static func newInstance(palette : ColorPalette) -> FoodSprite {
    foodIndex = Int(arc4random_uniform(UInt32(food.count))) //added
    let foodDish = FoodSprite(imageNamed: food[foodIndex])  //edited
